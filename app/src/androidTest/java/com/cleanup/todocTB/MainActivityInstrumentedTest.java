...
import com.cleanup.todocTB.ui.MainActivity;
...
public class MainActivityInstrumentedTest {
    ...
    public void sortTasks() {
        ...
        onView(TestUtils.withRecyclerView(R.id.list_tasks).atPositionOnView(0, R.id.lbl_task_name))
                .check(matches(withText("aaa Tâche example")));
        onView(TestUtils.withRecyclerView(R.id.list_tasks).atPositionOnView(1, R.id.lbl_task_name))
                .check(matches(withText("zzz Tâche example")));
        onView(TestUtils.withRecyclerView(R.id.list_tasks).atPositionOnView(2, R.id.lbl_task_name))
